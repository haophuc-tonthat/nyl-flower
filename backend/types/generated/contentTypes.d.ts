...
export interface ApiFeatureSectionFeatureSection
  ...
  info: {
    description: 'Feature section content for the homepage';
...
export interface ApiSliderSlider extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Slider content for the homepage';
    displayName: 'Slider';
    pluralName: 'sliders';
    singularName: 'slider';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    leftContent: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Kh\u00E1m ph\u00E1 v\u1EBB \u0111\u1EB9p tinh t\u1EBF c\u1EE7a nh\u1EEFng b\u00F4ng hoa t\u01B0\u01A1i. M\u1ED7i b\u00F3 hoa \u0111\u01B0\u1EE3c ch\u0103m ch\u00FAt t\u1EC9 m\u1EC9, k\u1EBFt h\u1EE3p gi\u1EEFa n\u00E9t \u0111\u1EB9p t\u1EF1 nhi\u00EAn v\u00E0 s\u1EF1 tinh t\u1EBF trong t\u1EEBng chi ti\u1EBFt, mang \u0111\u1EBFn n\u0103ng l\u01B0\u1EE3ng t\u00EDch c\u1EF1c cho kh\u00F4ng gian s\u1ED1ng.'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::slider.slider'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rightContent: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Hoa t\u01B0\u01A1i kh\u00F4ng ch\u1EC9 l\u00E0 m\u00F3n qu\u00E0 t\u1EB7ng \u00FD ngh\u0129a, m\u00E0 c\u00F2n l\u00E0 t\u00E1c ph\u1EA9m ngh\u1EC7 thu\u1EADt t\u1EF1 nhi\u00EAn, t\u00F4 \u0111i\u1EC3m cho kh\u00F4ng gian s\u1ED1ng c\u1EE7a b\u1EA1n th\u00EAm ph\u1EA7n \u1EA5m \u00E1p v\u00E0 t\u01B0\u01A1i s\u00E1ng.'>;
...
export interface ApiWelcomeWelcome extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Welcome section content for the homepage';
    displayName: 'Welcome';
    pluralName: 'welcomes';
  ...
  attributes: {
    ...
    description: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'N\u01A1i mang \u0111\u1EBFn nh\u1EEFng b\u00F3 hoa t\u01B0\u01A1i \u0111\u1EB9p nh\u1EA5t, \u0111\u01B0\u1EE3c thi\u1EBFt k\u1EBF b\u1EDFi c\u00E1c ngh\u1EC7 nh\u00E2n v\u1EDBi t\u00ECnh y\u00EAu v\u00E0 s\u1EF1 t\u1EADn t\u00E2m.'>;
    features: Schema.Attribute.Component<'shared.feature', true> &
      Schema.Attribute.Required;
    image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    quote: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'M\u1ED7i b\u00F3 hoa l\u00E0 m\u1ED9t t\u00E1c ph\u1EA9m ngh\u1EC7 thu\u1EADt, mang \u0111\u1EBFn ni\u1EC1m vui v\u00E0 h\u1EA1nh ph\u00FAc cho ng\u01B0\u1EDDi nh\u1EADn.'>;
    quoteAuthor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Ngh\u1EC7 nh\u00E2n cinh NYL'>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Ch\u00E0o m\u1EEBng \u0111\u1EBFn v\u1EDBi Ti\u1EC7m hoa cinh NYL'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
